...
import { Typography, Grid, Checkbox,ListItem, IconButton, Pagination, Divider } from '@mui/material'
...
const NalogDetailsPrint = ({nalog}) => {
    ...
    return (
                            ...
                            >
                                    ...
                                    <Grid item xs={1}  >
                                    <Typography sx={{ fontSize:'0.6rem'}}  > { nalog.godina} </Typography>
                                    </Grid>
                                    <Grid item xs={1}  >
                                    <Typography sx={{ fontSize:'0.6rem'}} >{ nalog.broj_izvoda}</Typography>
                                     </Grid>
                                ...
                                <Grid item xs={2} >
                                    <Typography sx={{ fontSize:"0.6rem"}} >{ (new Date(nalog.datum)).toLocaleDateString() }</Typography>
                                </Grid>
                                <Grid item xs={2} >
                                ...
                                <Grid item xs={3} >
                                    <Typography sx={{fontSize:'0.6rem'}} > {nalog.korisnik} </Typography>
                                </Grid>
                                <Grid item xs={1} >
                                    <Typography sx={{ fontSize:'0.6rem'}} > {nalog.deponent} </Typography>
                                </Grid>
                                <Grid item xs={1} >
