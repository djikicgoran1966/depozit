...
const NalogDetails = ({nalog}) => {
    // console.log("Datum je", nalog.datum)
  ...
  return (
                            ...
                            >
                                ...
                                <Grid item xs={1} >
                                    <Typography  sx={{ fontWeight:100,}} > { parseFloat(nalog.duguje).toFixed(2)} </Typography>
                                </Grid>
                                <Grid item xs={1} >
                                    <Typography  sx={{ fontWeight:100,}} > { parseFloat(nalog.potrazuje).toFixed(2)} </Typography>
                                </Grid>
